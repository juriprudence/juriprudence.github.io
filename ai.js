...
callback(result);
   ...
   xhr.send(JSON.stringify({"inputs":my_data+user_data,"parameters":{"return_full_text":false,"temperature":1,max_sequence_length:"20000"}}))
    ...
    get_fr_ai(textInput,input_crime_type,function(resul)
    {
       ...
       get_fr_ai(textInput,crim_patri,function(resp){
        ...
        document.getElementById("result").innerHTML =resp
          ...
          }else if (resul.includes("الأداب والأسرة")||resul.includes("اسرة"))
