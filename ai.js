...
callback(result);
   ...
   xhr.send(JSON.stringify({"inputs":my_data+user_data+"جريمة","parameters":{"return_full_text":false,"temperature":1,max_sequence_length:"20000"}}))
...
function sendTextToOpenAI() {
    ...
    crime_pub=" فعل حرر محرر فيه وقائع كادبة جريمة التزوير المادة 288 فعل أهان قاضيا أو موظفا أو ضابطا عموميا أو قائدا أو أحد رجال القوة العمومية  أثناء تأدية وظائفهم أو بمناسبة تأديتها وذلك بقصد المساس بشرفهم أو باعتبارهم أو بالإحترام الواجب لسلطتهم جريمة إهانة موظف المادة 144 فعل  شهد زورا في مواد الجنايات سواء ضد المتهم أو لصالحه جريمة شهادة الزور في جناية المادة 323 فقرة  1 فعل  شهد زورا في مواد الجنح سواء ضد المتهم أو لصالحه جريمة شهادة الزور في جنحة المادة 233 فعل  شهد زورا في مواد المخالفات سواء ضد المتهم أو لصالحه شهادة الزور في مخالفة جريمة شهادة الزور في مخالفة المادة 234 فعل قلد خاتم الدولة أو استعمل الخاتم المقلد جريمة تقليد اختام الدولة المادة 205 فعل كل شخص وجهت إليه اليمين أو ردت عليه في المواد المدنية وحلفها كذبا جريمة اليمين الكادبة المادة 240 فعل قلد أو زور أو زيف نقودا معدنية أو أوراقا نقدية ذات سعر قانوني في الإقليم الوطني أو في الخارج سندات أو أذونات أو أسهم تصدرها الخزينة العمومية وتحمل طابعها أو علامتها أو قسائم الأرباح العائدة من هذه السندات أو الأذونات أو الأسهم جريمة تزوير نقود المادة 197 فعل  كل موظف عمومي يقوم بإبرام عقد أو يؤشر أو يراجع عقدا أو اتفاقية أو صفقة أو ملحقا مخالفا بذلك الأحكام التشريعية والتنظيمية الجاري بها العمل بغرض إعطاء امتيازات غير مبررة للغير جريمة منح امتيازات غير مبرر في مجال الصفقات العمومية المادة 26 من ق مكافحة الفساد  فعل قام بتسهيل حصول ب على صفقة عمومية مقابل مبلغ من النقود منح امتيازات غير مبرر في مجال الصفقات العمومية المادة 26 من قانون مكافحة الفساد فعل تاجر أو صناعي أو حرفي أو مقاول من القطاع الخاص، أو بصفة عامة كل شخص طبيعي أو معنوي يقوم، ولو بصفة عرضية ، بإبرام عقد أو صفقة مع الدولة أو الجماعات المحلية أو المؤسسات أو الهيئات العمومية الخاضعة للقانون العام أو المؤسسات العمومية الاقتصادية والمؤسسات العمومية ذات الطابع الصناعي والتجاري، ويستفيد من سلطة أو تأثير أعوان الهيئات المذكورة من أجل الزيادة في الأسعار التي يطبقونها عادة أو من أجل التعديل لصالحهم في نوعية المواد أو الخدمات أو آجال التسليم أو التموين منح امتيازات غير مبرر في مجال الصفقات العمومية المادة 26 من قانون مكافحة  فعل كل موظف عمومي يقبض أو يحاول أن يقبض لنفسه أو لغيره، بصفة مباشرة أو غير مباشرة، أجرة أو منفعة مهما يكن نوعها بمناسبة تحضير أو إجراء مفاوضات قصد إبرام أو تنفيذ صفقة أو عقد أو ملحق باسم الدولة أو الجماعات المحلية أو المؤسسات العمومية ذات الطابع الإداري أو المؤسسات العمومية ذات الطابع الصناعي والتجاري أو المؤسسات العمومية الاقتصادية جريمة الرشوة في مجال الصفقات العمومية  مادة 27 قانون مكافحة الفساد فعل كل موظف عمومي يختلس أو يتلف أو يبدد أو يحتجز عمدا وبدون وجه حق أو يستعمل على نحو غير شرعي لصالحه أو لصالح شخص أو كيان آخر، أية ممتلكات أو أموال أو أوراق مالية عمومية أو خاصة أو أي أشياء أخرى ذات قيمة عهد بها إليه بحكم وظائفه أو بسببها جريمة  اختلاس الممتلكات من قبل موظف عمومي أو استعمالها على نحو غير شرعي المادة 29 من قانون مكافحة الفساد فعل كل موظف عمومي يطالب أو يتلقى أو يشترط أو يأمر بتحصيل مبالغ مالية يعلم أنها غير مستحقة الأداء أو يجاوز ماهو مستحق سواء لنفسه أو لصالح الإدارة أو لصالح الأطراف الذين يقوم بالتحصيل لحسابهم جريمة الغدر المادة 30 من قانون مكافحة الفساد فعل كل من وعد موظفا عموميا أو أي شخص آخر بأية مزية غير مستحقة أو عرضها عليه أو منحه إياها، بشكل مباشر أو غير مباشر، لتحريض ذلك الموظف العمومي أو الشخص على استغلال نفوذه الفعلي أو المفترض بهدف الحصول من إدارة أو من سلطة عمومية على مزية غير مستحقة لصالح المحرض الأصلي على ذلك الفعل أو لصالح أي شخص آخر جريمة استغلال النفود المادة 32 من قانون مكافحة الفساد فعل كل موظف عمومي أو أي شخص آخر يقوم بشكل مباشر أو غير مباشر، بطلب أو قبول أية مزية غير مستحقة لصالحه أو لصالح شخص آخر لكي يستغل ذلك الموظف العمومي أو الشخص نفوذه الفعلي أو المفترض بهدف الحصول من إدارة أو سلطة عمومية على منافع غير مستحقة جريمة استغلال النفود المادة 32 من قانون مكافحة الفساد فعل قام سليم محضر قضائي باخد مبلغ يتجاوز النسبة القانونية جريمة الغدر المادة 30 فعل"
    input_crime_type="فعل سرق شيء ليس ملكه جريمة ضد الأموال فعل ضرب قتل شخص جريمة ضد الأشخاص فعل ضرب احمد وسبب له عجز علي جريمة ضد الأشخاص فعل قتل سمير علي جريمة ضد الأشخاص فعل سرق احمد ما لا يملكه جريمة ضد الأموال فعل اخد احمد نقود  او شيء مبلغ مالي نقود علي جريمة ضد الأموال فعل سرق احمد علي جريمة ضد الأموال فعل قتل احمد سليم جريمة ضد الأشخاص فعل قام بايهام الضحية انه تاجر و اخد ماله جريمة ضد الأموال فعل  لم يدفع النفقة جريمة الأداب والأسرة فعل قام باغتصاب علني مخل بالحياء جريمة الأداب والأسرة فعل اخد سليم شيء من علي جريمة ضد الأموال فعل ابعد او لم يسلم او اهمل قاصر جريمة الأداب والأسرة فعل لم يسلم طفل الى وليه الشرعي جريمة الأداب والأسرة فعل اجهض امرءة حامل او مفترض حملها جريمة الأداب والأسرة فعل قال لفلان انت جريمة ضد الأشخاص  فعل لم يدفع النفقة جريمة الأداب والأسرة  فعل ترك مقر الاسرة جريمة الأداب والأسرة  فعل اقام علاقة مع امرئة متزوجة جريمة جريمة الأداب والأسرة  فعل احرق شيء حطم شيء جريمة ضد الأموال فعل قام بتزوير جريمة ضد الدولة فعل اهان موظف جريمة ضد الدولة فعل قام بشهادة زور جريمة ضد الدولة فعل قام بالنصب على فلان جريمة ضد الأموال فعلاصدر شيك بدون رصيد جريمة ضد الأموال فعل قام باختلاس أموال شركته جريمة صد الأموال فعل وضع النار جريمة ضد الأموال فعل حرض على الدعارة او الفسق جريمة ضد الأسرة والأداب فعل تسبب في مرض او عجز جريمة ضد الأموال فعل قام بالاحتيال جريمة ضد الأموال فعل قام بتزوير نقود جريمة ضد الدولة فعل "
